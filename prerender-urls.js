module.exports = async function() {
  let urlArray = [{
    url: '/',
    title: 'dddd',
    subtitle: 'fff to radio, podcasts and create playlists',
    description: 'ffListen to radio, podcasts and create playlists.',
  ...
  await fetch('https://www.canara.org/index.php?option=com_k2&view=itemlist&layout=category&task=category&id=912&format=json', {
    method: 'get'
